...
# Também funciona para substituir o Reload Page
# Test Teardown         After Test Tentative Create Product

# Tive que criar esse novo keyword para burlar o Reload Page
# Test Setup            Tentative Create Product
